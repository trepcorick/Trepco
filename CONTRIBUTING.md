Contributing to Trepco Core
============================

The Trepco Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Trepco Core project, and is not to be
confused with overall Trepco Network Protocol consensus changes.

Whether a pull request is merged into Trepco Core rests with the project merge
...
Patches that change Trepco consensus rules are considerably more involved than
...
Where a patch set proposes to change the Trepco consensus, it must have been
...
The project leader is the release manager for each Trepco Core release.
