...
In order to support loading of multiple wallets in trepco-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is trepco.cpp.
...
Changes to trepco.cpp
----------------------
trepco.cpp is the entry point into trepco-qt, and as such, will require some minor modifications to provide hooks for
