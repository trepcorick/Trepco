...
RESOURCES += src/qt/trepco.qrc src/qt/trepco_locale.qrc

TRANSLATIONS += src/qt/locale/trepco_bg.ts \
                src/qt/locale/trepco_de.ts \
                src/qt/locale/trepco_en.ts \
                src/qt/locale/trepco_es.ts \
                src/qt/locale/trepco_fi.ts \
                src/qt/locale/trepco_fr.ts \
                src/qt/locale/trepco_it.ts \
                src/qt/locale/trepco_ja.ts \
                src/qt/locale/trepco_pl.ts \
                src/qt/locale/trepco_pt.ts \
                src/qt/locale/trepco_ru.ts \
                src/qt/locale/trepco_sk.ts \
                src/qt/locale/trepco_sv.ts \
                src/qt/locale/trepco_vi.ts \
                src/qt/locale/trepco_zh_CN.ts \
                src/qt/locale/trepco_zh_TW.ts
