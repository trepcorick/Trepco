...
#   c) node1 mines 32 blocks, so now node 0 has 60001trep, node 1 has 4250trep, node2 has none.
#   d) node0 sends 601 trep to node2, in two transactions (301 trep, then 300 trep).
