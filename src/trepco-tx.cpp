...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Trepco Core trepco-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  trepco-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded trepco transaction") + "\n" +
                               "  trepco-tx [options] -create [commands]   " + _("Create hex-encoded trepco transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded trepco transaction
