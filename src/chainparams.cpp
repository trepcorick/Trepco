...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("000002cb77707966c483a1ebbaf4998727400a83a6dfdb8e0278dc23a4867c92"));
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1536994898, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 60 * 60; // Trepco: 1 hr
        nTargetSpacing = 120;  // Trepco: 2 min
        nMaturity = 10;
        nMasternodeCollateral = 40000; // 40,000 TREP
        ...
        genesis.nNonce = 5182056;

        hashGenesisBlock = genesis.GetHash();
        assert(genesis.hashMerkleRoot == uint256("0xf1021dcbc1f995b850a7b38c4744b645f34b1b4b106351b93f07d4a76d16b073"));
        assert(hashGenesisBlock == uint256("0x000002cb77707966c483a1ebbaf4998727400a83a6dfdb8e0278dc23a4867c92"));
...
public:
    CTestNetParams()
    {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("trepco.io", "testnet-seeds.trepco.io"));             // Primary DNS Seeder
        vSeeds.push_back(CDNSSeedData("trepcoin.com", "test.trepco.io"));      // Secondary DNS Seeder

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 128); // Testnet trepco addresses start with 't''
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 125);  // Testnet trepco script addresses start with 's'
        ...
        // Testnet trepco BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 60 * 60; // Trepco: 1 hour
        nTargetSpacing = 120;        // Trepco: 2 min
