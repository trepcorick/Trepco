...
/** Utility functions used by the Trepco Qt UI.
 */
namespace GUIUtil
{
...
// Render Trepco addresses in monospace font
...
// Parse "trepco:" URI into recipient object, return true on successful parsing
