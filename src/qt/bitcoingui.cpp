                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Trepco Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Trepco address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and trepco: URIs)"));
...
/*
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zTREP"));
...
*/
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Trepco Core"), this);
    aboutAction->setStatusTip(tr("Show information about Trepco Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Trepco"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Trepco addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Trepco addresses"));
    ...
    openAction->setStatusTip(tr("Open a Trepco: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Trepco Core help message to get a list with possible Trepco command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Trepco Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Trepco network", "", count));
}
...
{
    QString strTitle = tr("Trepco Core"); // default title
