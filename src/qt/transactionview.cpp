 ...
 */
    ...
    typeWidget->addItem(tr("Received Trep from zTrep"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zTrep"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zTrep));
