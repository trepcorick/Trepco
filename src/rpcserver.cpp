...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Trepco features */
        {"trepco", "masternode", &masternode, true, true, false},
        {"trepco", "listmasternodes", &listmasternodes, true, true, false},
        {"trepco", "getmasternodecount", &getmasternodecount, true, true, false},
        {"trepco", "masternodeconnect", &masternodeconnect, true, true, false},
        {"trepco", "masternodecurrent", &masternodecurrent, true, true, false},
        {"trepco", "masternodedebug", &masternodedebug, true, true, false},
        {"trepco", "startmasternode", &startmasternode, true, true, false},
        {"trepco", "createmasternodekey", &createmasternodekey, true, true, false},
        {"trepco", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"trepco", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"trepco", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"trepco", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"trepco", "getmasternodescores", &getmasternodescores, true, true, false},
        {"trepco", "mnbudget", &mnbudget, true, true, false},
        {"trepco", "preparebudget", &preparebudget, true, true, false},
        {"trepco", "submitbudget", &submitbudget, true, true, false},
        {"trepco", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"trepco", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"trepco", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"trepco", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"trepco", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"trepco", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"trepco", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"trepco", "checkbudgets", &checkbudgets, true, true, false},
        {"trepco", "mnsync", &mnsync, true, true, false},
        {"trepco", "spork", &spork, true, true, false},
        {"trepco", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"trepco", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
{
    return "> trepco-cli " + methodname + " " + args + "\n";
}
